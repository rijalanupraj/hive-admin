...
const TABLE_HEAD = [
  { id: "reported", label: "Reported", alignRight: false },
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers
                    ...
                    .map(row => {
                      const { _id, reportedUser, reportedBy, subject, description } = row;
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell align='right'>
                            <UserMoreMenu onDelete={() => handleDeleteUser(_id)} userName={""} />
                          </TableCell>
                        </TableRow>
                      );
                    })}
